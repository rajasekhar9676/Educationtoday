                ...
                <tr>
                    ...
                    <td>
                        @if($subcategory->meta_banner)
                            ...
                            <img src="{{ Storage::url($subcategory->meta_banner) }}" width="50" height="50" alt="Meta Banner">
                    ...
                    <td>
                        @if($subcategory->thumbnail)
                            ...
                            <img src="{{ Storage::url($subcategory->thumbnail) }}" width="50" height="50" alt="Thumbnail">
